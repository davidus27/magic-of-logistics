...
| Specification area | Generated assets |
|---|---|
| General paper-and-ink style | Palette, paper grain, all SVGs |
| Entity symbols | Cargo, rider, wizard, defenders, enemies, barrier, portal |
...
| Sound design | Click, paper tap, ink stroke, paper tear, portal low tone |
| Not an image asset | Collision, AI, navigation, telemetry, timings, and simulation behavior |
